...
def main():
    ...
    parser.add_argument('--size', type=int, default=50, help='Size of the grid map (default: 50)')
    parser.add_argument('--warehouses', type=int, default=5, help='Number of warehouses (default: 5)')
    parser.add_argument('--package-points', type=int, default=10, help='Number of package points (default: 10)')
    parser.add_argument('--destinations', type=int, default=15, help='Number of destinations (default: 15)')
    parser.add_argument('--couriers', type=int, default=20, help='Number of couriers (default: 20)')
    parser.add_argument('--packages', type=int, default=100, help='Number of packages (default: 100)')
    ...
    parser.add_argument('--max-arrival-time', type=int, default=50, help='Maximum arrival time for packages (default: 50)')
